...
const envSchema = z.object({
  ...
  AUTONOMY_CRON: z.string().default('* * * * *'),
  AUTONOMY_TOP_ACTIONS_LIMIT: z.coerce.number().default(30),
  AUTONOMY_MAX_ACTIONS_PER_TICK: z.coerce.number().default(100),
  AUTONOMY_MAX_LOVABLE_BUILDS_PER_TICK: z.coerce.number().default(1),
  AUTONOMY_MAX_JOBS_PER_TICK: z.coerce.number().default(100),
  AUTONOMY_MAX_DIAGNOSE_JOBS_PER_TICK: z.coerce.number().default(8),
  AUTONOMY_MAX_LOVABLE_JOBS_PER_TICK: z.coerce.number().default(1),
  AUTONOMY_MAX_FILMER_JOBS_PER_TICK: z.coerce.number().default(100),
  AUTONOMY_JOB_LOCK_MINUTES: z.coerce.number().default(30),
  AUTONOMY_DEAD_AFTER_ATTEMPTS: z.coerce.number().default(3),
  LOVABLE_BUILD_INTERVAL_HOURS: z.coerce.number().default(0.01),
  ...
  EMAIL_VALIDATION_ENABLED: boolFromEnv.default('true'),
  ...
  DAILY_CODER_TEMPLATE_LIMIT: z.coerce.number().default(100),
  DAILY_SEND_LIMIT: z.coerce.number().default(100000),
  OUTBOUND_WORKING_HOURS_START: z.coerce.number().default(8),
  OUTBOUND_WORKING_HOURS_END: z.coerce.number().default(20),
